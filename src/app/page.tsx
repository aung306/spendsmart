  ...
  return (
    <div className="grid grid-rows-[20px_1fr_20px] min-h-screen p-8 pb-20 gap-16 sm:p-20">
      ...
      <main className="flex flex-col gap-8 row-start-2 items-center sm:items-start">
        ...
        <Link href="/signup"><button className="mt-20 bg-white text-[#000C2F] px-4 py-2 rounded-lg hover:bg-[#C9CFFF] underline w-30 cursor-pointer">Get Started</button></Link>
      </main>
